...
- Mozilla Firefox: [Link to Text Fragment extension](https://addons.mozilla.org/firefox/addon/link-to-text-fragment/) (beta)
- Apple Safari: [Link to Text Fragment extension](https://apps.apple.com/app/link-to-text-fragment/id1532224396?l=en&mt=12) (beta)
